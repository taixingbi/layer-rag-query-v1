...
async def _generate_follow_up_candidates(
    *,
    ...
    sys = (
        ...
        "for their question. The context summary lists every retrieved passage "
        "(with source labels) shown to the answer model. Generate questions that "
        "help the user explore that material: clarifications, edge cases, next "
        "steps, or related aspects from any listed source. Each question must be "
        "answerable from those retrieved passages only. Do not repeat the "
